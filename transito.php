...
<body>
 ...
 <section class="container-fluid" id="transitosec">

  <div class="row">
    <div class="col-md-12 text-center">
      <h1 class="titulo">Inteligência de Rodovias</h1>
      <h2 class="subtitulo">Serviços de estatística de trânsido e operação de rodovias.</h2>
    </div>
  </div>
   <div class="row">
 ...
 <section class="container-fluid text-center cards" >
   <div class="row">
     <div class="col-md-12 text-center">
 ...
 <section class="container-fluid diferenciais" >
   <div class="row">
     <div class="col-md-12 text-center">
       ...
       <h2 class="subtitulo">Porque escolher as nossas soluções?</h2>
     </div>
   </div>
   <div class="row">
     <div class="col-md-12 col-xs-12 text-center">
     <ul>
       <li><span class="glyphicon glyphicon-ok"></span> Lorem ipson dolor lalala</li>
       <li><span class="glyphicon glyphicon-ok"></span> Lorem ipson dolor lalala</li>
       <li><span class="glyphicon glyphicon-ok"></span> Lorem ipson dolor lalala</li>
       <li><span class="glyphicon glyphicon-ok"></span> Lorem ipson dolor lalala</li>
     </ul>
